...
class StopConfigurationLoader:
    ...
    def _validate_numeric_fields(fields: dict[str, Any]) -> dict[str, Any]:
        ...
        """
        return {
            "max_hours_in_advance": StopConfigurationLoader._validate_max_hours_in_advance(
                fields.get("max_hours_in_advance")
            ),
            "platform_filter": StopConfigurationLoader._validate_platform_filter(
                fields.get("platform_filter")
            ),
            "fetch_max_minutes_in_advance": StopConfigurationLoader._validate_fetch_max_minutes_in_advance(
