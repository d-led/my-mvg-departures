"""VBB (Verkehrsverbund Berlin-Brandenburg) profile for pyhafas.

Based on hafas-client JavaScript implementation:
https://github.com/public-transport/hafas-client/tree/main/p/vbb
"""
...
class VBBProfile(BaseProfile):
    """
    Profile of the HaFAS of Verkehrsverbund Berlin-Brandenburg (VBB).

    Based on the JavaScript hafas-client VBB profile configuration.
    """
